...
:::: {.column width="50%"}
::: fragment
[![Yougov Iran nuclear deal question](images/irandeal.png)](https://today.yougov.com/politics/articles/12877-most-americans-now-support-iran-deal)
:::
::::
::::::
...
# Problematic Questions: double-barreled items

::::: columns
::: {.column width="50%"}
-   This is an example of a double-barreled question. I might want to spend more on welfare and less on national defense, or vice versa.
...
::: {.column width="50%"}
[![GSS Spending Questions](images/gss_spending.png){fig-align="center"}](https://gss.norc.org/get-documentation/questionnaires.html)
:::
:::::
...
::: {.column width="50%"}
[![Question from the 1992 ISSP](images/protest_action.png){fig-align="center"}](https://www.gesis.org/en/issp)
:::
:::::
...
::: {.column width="50%"}
[![Question from NHANES](images/nhanes_alcohol.png){fig-align="center"}](https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2021/DataFiles/ALQ_L.htm#ALQ111)
:::
:::::
...
::: {.column width="50%"}
[![NCVS alternative theft questions](images/ncvs_theft.png){fig-align="center"}](https://bjs.ojp.gov/document/NCVS_Redesign_Questionnaire.pdf)
:::
:::::
...
::: {.column width="50%"}
[![Marijuana questions on the Youth Risk Behavior Survey](images/drug_abuse.png)](https://www.cdc.gov/yrbs/questionnaires/index.html)
...
::::: columns
::: {.column width="50%"}
-   Mentioning one party here is likely to nudge respondents toward blaming Democrats, and the response options would fail to capture the possibility of assigning equal blame to both parties.
:::

::: {.column width="50%"}
[![Yougov's shutdown question](images/blame_shutdown.png){fig-align="center"}](https://today.yougov.com/topics/politics/survey-results/daily/2025/11/10/2927c/2)
:::
:::::
...
::: {.column width="50%"}
![](images/Likert-Scale-7-point-scales.webp){fig-align="center" width="70%"}
:::
:::::
...
-   The lack of balance raised serious questions about bias: acquiescence bias would probably inflate the estimates of authoritarian attitudes.
:::
...
::: {.column width="50%"}
![https://www.pewresearch.org/short-reads/2024/03/05/online-opt-in-polls-can-produce-misleading-results-especially-for-young-people-and-hispanic-adults/](images/submarine_question.png)
:::
:::::
